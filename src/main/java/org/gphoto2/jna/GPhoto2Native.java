...
public interface GPhoto2Native extends Library {
    ...
    int gp_widget_get_info(Pointer widget, PointerByReference /**char ** **/ info);

    int gp_widget_get_id(Pointer widget, IntByReference id);

    int gp_widget_get_type(Pointer widget, IntByReference type);

    int gp_widget_get_label(Pointer widget, PointerByReference /**char ** **/ label);
    ...
    int gp_widget_get_choice(Pointer widget, int choice_number, PointerByReference /**char ** **/ choice);
